...
public class DBConstants {
    ...
    public static final String GET_TICKET_UNPARKED = "" +
            ...
            "where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? and OUT_TIME is not null " +
            "order by t.IN_TIME  " +
            "limit 1";
    public static final String GET_TICKET_PARKED = "" +
            "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME, p.TYPE " +
            "from ticket t,parking p " +
            "where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? and OUT_TIME is null " +
            "order by t.IN_TIME  " +
            "limit 1";

    public static final String GET_PARKING_AVAILABILITY = "select AVAILABLE from parking where PARKING_NUMBER = ?";
